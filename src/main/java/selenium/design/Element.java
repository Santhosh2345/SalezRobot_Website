...
public interface Element {
	...
	public void click2(WebElement ele, String name, String url) throws InterruptedException;
	/**
	 ...
	 * @see locateElement method in Browser Class
	 * @author Venkataraghavan
	 * @throws ElementNotInteractable,IllegalArgumentException(throws if@Override
	 keysToSend is null)		 
	 */
